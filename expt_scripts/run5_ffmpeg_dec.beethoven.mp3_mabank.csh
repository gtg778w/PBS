#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="dec.beethoven.mp3"
    ...
    set alpha_array=("0.95632" "1.06363" "1.21973" "1.43436" "1.88312" "3.75625" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 5:0:4.896000"
