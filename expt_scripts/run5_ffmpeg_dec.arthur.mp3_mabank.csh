#! /bin/csh -x
    ...
    set alpha_array=("1.20021" "1.35631" "1.55143" "1.80508" "2.19531" "2.97578" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 1:4:33.312000"
