#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.beethoven.wav.ogg"
    ...
    set alpha_array=("1.04412" "1.17095" "1.31729" "1.49289" "1.76605" "2.19531" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 5:0:4.223719"
