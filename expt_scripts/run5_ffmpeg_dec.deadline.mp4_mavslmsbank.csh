#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="dec.deadline.mp4"
    ...
    set alpha_array=("1.20021" "1.29777" "1.41484" "1.55143" "1.80508" "2.50750" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:34:20.999868"
