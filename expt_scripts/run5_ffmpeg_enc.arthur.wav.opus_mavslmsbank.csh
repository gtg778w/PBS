#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.arthur.wav.opus"
    ...
    set alpha_array=("1.57094" "1.66850" "1.76605" "1.87337" "2.01971" "2.23434" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 1:4:32.255939"
