#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.highway.y4m.webm"
    ...
    set alpha_array=("0.88803" "1.04412" "1.37582" "1.88312" "3.13187" "10.00000" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:39:59.999976"
