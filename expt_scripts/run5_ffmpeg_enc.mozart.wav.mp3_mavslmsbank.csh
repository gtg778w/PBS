#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.mozart.wav.mp3"
    ...
    set alpha_array=("1.05388" "1.18070" "1.33680" "1.57094" "1.84410" "2.42945" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 1:15:3.531957"
