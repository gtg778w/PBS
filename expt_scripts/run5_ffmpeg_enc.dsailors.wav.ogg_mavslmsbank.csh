#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.dsailors.wav.ogg"
    ...
    set alpha_array=("0.28316" "0.41975" "0.63437" "0.94656" "1.72703" "3.75625" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 2:50:43.507902"
