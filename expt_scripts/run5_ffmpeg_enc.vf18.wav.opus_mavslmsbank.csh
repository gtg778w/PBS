#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.vf18.wav.opus"
    ...
    set alpha_array=("1.60508" "1.65386" "1.70752" "1.77581" "1.88312" "2.11727" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 1:36:7.679910"
