#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.sintel.wav.mp3"
    ...
    set alpha_array=("1.01485" "1.13192" "1.29777" "1.45387" "1.76605" "2.35141" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:31:12.383971"
