#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.cc.wav.opus"
    ...
    set alpha_array=("0.95632" "1.00998" "1.07339" "1.14168" "1.22948" "1.33680" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 1:27:30.079950"
