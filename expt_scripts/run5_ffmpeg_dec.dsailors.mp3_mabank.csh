#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="dec.dsailors.mp3"
    ...
    set alpha_array=("0.98559" "1.12217" "1.27826" "1.53191" "2.03922" "3.44406" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 2:50:42.905760"
