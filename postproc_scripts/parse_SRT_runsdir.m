function [SRT_records] = parse_SRT_runsdir(dirname)

    file_name_list = readdir(dirname);
    ...
    for i = 1:file_count
        ...
        SRT_record = parse_SRT_run(dirname, next_file_name);
        SRT_records = [SRT_records, SRT_record];
    end
    
    mat_name = strcat(dirname, '.mat');
