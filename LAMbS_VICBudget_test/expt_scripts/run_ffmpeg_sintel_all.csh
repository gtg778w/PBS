#! /bin/csh -x
    ...
    echo "*******************************************************************************"
    echo "run the ffmpeg workload at maximum frequency with time-based budget"
    echo "*******************************************************************************"

    set LOGDIR="${ROOT_LOGDIR}/max_freq/time/"
    csh ${SCRIPTDIR}/core_ffmpeg_sintel.csh ${repetitions} ${FC_DURATION} "0.9" "0.9" ${LOGDIR} ${SCRIPTDIR} ${PeSoRTADIR} ${BINDIR}
    ...
    echo "*"
    echo "*******************************************************************************"
    echo "run the ffmpeg workload at minimum frequency with time-based budget"
    echo "*******************************************************************************"
    
    set LOGDIR="${ROOT_LOGDIR}/min_freq/time/"
    csh ${SCRIPTDIR}/core_ffmpeg_sintel.csh ${repetitions} ${FC_DURATION} "0.0" "0.0" ${LOGDIR} ${SCRIPTDIR} ${PeSoRTADIR} ${BINDIR}
    echo "*"
    echo "*"
    echo "*******************************************************************************"
    echo "*******************************************************************************"
    ...
    echo "*"
    echo "*******************************************************************************"
    echo "run the ffmpeg workload at oscillating frequency with time-based budget"
    echo "*******************************************************************************"
    
    set LOGDIR="${ROOT_LOGDIR}/oscil_freq/time/"
    csh ${SCRIPTDIR}/core_ffmpeg_sintel.csh ${repetitions} ${FC_DURATION} "0.0" "0.9" ${LOGDIR} ${SCRIPTDIR} ${PeSoRTADIR} ${BINDIR}
    echo "*"
    echo "*"
    echo "*******************************************************************************"
    echo "*******************************************************************************"
