#! /bin/csh -x
    ...
    echo "*******************************************************************************"
    echo "run_ffmpeg_dec.sintelfull.mkv_mavslmsbank_freqvarcycle_ns.csh"
    echo "*******************************************************************************"

    csh ${EXPTDIR}/run_ffmpeg_dec.sintelfull.mkv_mavslmsbank_freqvarcycle_ns.csh ${repetitions} ${LOGDIR} ${PeSoRTADIR} ${BINDIR}
    echo "*"
    echo "*"
    echo "*******************************************************************************"
    echo "*******************************************************************************"
    ...
    echo "*"
    echo "*******************************************************************************"
    echo "run_ffmpeg_dec.sintelfull.mkv_mavslmsbank_freqvarcycle_VIC.csh"
    echo "*******************************************************************************"

    csh ${EXPTDIR}/run_ffmpeg_dec.sintelfull.mkv_mavslmsbank_freqvarcycle_VIC.csh ${repetitions} ${LOGDIR} ${PeSoRTADIR} ${BINDIR}
    echo "*"
    echo "*"
    echo "*******************************************************************************"
    echo "*******************************************************************************"
