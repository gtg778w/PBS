#! /bin/csh
    ...
    set test_log_dir="${VICtestdir}/data/VICtimer"
    mkdir -p ${test_log_dir}
    
    set bindir="/home/gtg778w/Desktop/bin"
    
    set test_mod_dir="${VICtestdir}/mod"
    set mod="${test_mod_dir}/VICtimer_response_test.ko"
    ...
    foreach testinterval (${test_interval_array})
        ...
        foreach cpufreqi (`seq 1 1 $#cpufreq_name_array`)
            ...
            set logfile_name="${test_log_dir}/VICtimer_response_test_${test_length}_${testinterval}_${cpufreq_name}.csv"
            ...
            insmod $mod test_length=${test_length} test_interval=${testinterval}
            sleep $testtime
            rmmod  $mod
            cp /var/log/VICtimer_response_test_log.csv ${logfile_name}
