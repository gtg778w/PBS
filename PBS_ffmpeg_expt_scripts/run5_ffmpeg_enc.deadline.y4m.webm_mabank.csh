#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.deadline.y4m.webm"
    ...
    set alpha_array=("1.45387" "2.03922" "2.97578" "10.00000" "10.00000" "10.00000" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:27:28.799984"
