#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="enc.mad900.y4m.webm"
    ...
    set alpha_array=("1.00510" "1.25875" "2.11727" "3.60016" "10.00000" "10.00000" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:17:59.999989"
