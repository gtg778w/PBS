#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="dec.factory.webm"
    ...
    set alpha_array=("1.18070" "1.33680" "1.53191" "1.74654" "2.07824" "2.81969" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:33:28.499871"
