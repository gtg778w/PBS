#! /bin/csh -x
    ...
    set alpha_array=("0.98559" "1.23924" "1.57094" "2.07824" "2.74164" "3.91234" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 1:36:7.560000"
