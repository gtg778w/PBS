#! /bin/csh -x
    ...
    set alpha_array=("1.02461" "1.18070" "1.37582" "1.68801" "2.19531" "3.75625" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:31:13.152000"
