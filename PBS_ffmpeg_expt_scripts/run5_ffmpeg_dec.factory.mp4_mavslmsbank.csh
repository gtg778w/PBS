#! /bin/csh -x
    ...
    set APPNAME="ffmpeg"
    set CONFIGNAME="dec.factory.mp4"
    ...
    set alpha_array=("0.98559" "1.15144" "1.41484" "1.72703" "2.50750" "10.00000" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:26:46.799984"
