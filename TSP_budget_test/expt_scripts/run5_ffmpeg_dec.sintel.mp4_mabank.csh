#! /bin/csh -x
    ...
    set alpha_array=("0.56729" "0.64540" "0.74304" "0.84068" "0.99689" "1.21170" "1.46555" "1.95373" "2.65672" )
    ...
    foreach alpha ($alpha_array)
        ...
        foreach rep (`seq 1 1 ${repetitions}`)
            ...
            echo "Approximate total duration of experiment: 0:46:59.249955"
            ...
            sleep 0.5
            #Run the SRT task
            ${BINDIR}/${APPNAME}_pbsSRT -f -W ${W1} -D ${D1} -J ${J1} -A ${A1} -p ${p1} -c ${c1} -a ${alpha} -L 1 -R ${SRT_logfile} &
