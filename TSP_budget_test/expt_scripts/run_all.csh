#! /bin/csh -x
    ...
    csh ${SCRIPTDIR}/run_ffmpeg_enc.beethoven.wav.mp3_mavslmsbank.csh    ${repetitions} "mavslmsbank" ${OUTDIR} ${BINDIR} ${PeSoRTADIR}
    ...
    csh ${SCRIPTDIR}/run_ffmpeg_enc.highway.y4m.mp4_ma.csh           ${repetitions} "ma" ${OUTDIR} ${BINDIR} ${PeSoRTADIR}
    csh ${SCRIPTDIR}/run_ffmpeg_enc.highway.y4m.mp4_mabank.csh       ${repetitions} "mabank" ${OUTDIR} ${BINDIR} ${PeSoRTADIR}
    csh ${SCRIPTDIR}/run_ffmpeg_enc.highway.y4m.mp4_mavslmsbank.csh  ${repetitions} "mavslmsbank" ${OUTDIR} ${BINDIR} ${PeSoRTADIR}
